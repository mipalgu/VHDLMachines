...
//            ("test_write2", test_write2)
    ...
    public override func setUp() {
        self.machine = VHDLMachines.Machine(
            ...
            transitions: [ VHDLMachines.Transition(condition: "false", source: 0, target: 1), VHDLMachines.Transition(condition: "after_ms(50) or after(2)", source: 0, target: 1), VHDLMachines.Transition(condition: "true", source: 0, target: 1), VHDLMachines.Transition(condition: "xx = '1'", source: 1, target: 2), VHDLMachines.Transition(condition: "x = '1'", source: 1, target: 2), VHDLMachines.Transition(condition: "true", source: 1, target: 0) ],
            initialState: 0,
            suspendedState: 1,
