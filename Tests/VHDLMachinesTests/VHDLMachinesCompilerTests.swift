...
//            ("test_write2", test_write2)
    ...
    public override func setUp() {
        self.machine = VHDLMachines.Machine(
            ...
            externalSignals: [ExternalSignal(type: "std_logic", name: "x", mode: .input, defaultValue: "'1'", comment: "A std_logic variable.")],
            externalVariables: [VHDLVariable(type: "integer", name: "y", defaultValue: "0", range: (0, 65535), comment: "A uint16 variable called y.")],
