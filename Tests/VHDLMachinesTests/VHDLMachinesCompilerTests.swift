...
//            ("test_write2", test_write2)
    ...
    public override func setUp() {
        self.machine = VHDLMachines.Machine(
            ...
            externalVariables: [VHDLVariable(type: "boolean", name: "isX", defaultValue: "true", range: nil, comment: "A bool called isX"), VHDLVariable(type: "natural", name: "genA", defaultValue: "12", range: (0, 65535), comment: "uint16")],
