...
//            ("test_write2", test_write2)
    ...
    public override func setUp() {
        self.machine = VHDLMachines.Machine(
            ...
            returnableVariables: [ReturnableVariable(type: "interger", name: "retA", comment: "-- Returnable retA"), ReturnableVariable(type: "boolean", name: "retIsA", comment: "-- Returnable retIsA")],
